...
// will each own their own shaders/passes too, all consuming the same Scene and
// Camera, so the three pipelines can be benchmarked under identical conditions.
